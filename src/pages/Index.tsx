...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="relative z-10">
        <section className="container mx-auto px-4 py-20 text-center">
          ...
          <div className="flex justify-center gap-4">
            <Button onClick={() => navigate("/auth")} size="lg" className={isLite ? '' : 'shadow-lg'}>
              Comenzar Ahora
            </Button>
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className={`rounded-lg border border-primary/30 ${isLite ? 'bg-card p-6' : 'bg-card/50 md:backdrop-blur-sm p-6 shadow-sm transition-all hover:shadow-[0_0_20px_hsl(0_85%_50%_/_0.3)] hover:border-primary/60 hover:bg-card/70'}`}>
              <Send className={`mb-4 h-10 w-10 text-primary ${isLite ? '' : 'md:drop-shadow-[0_0_8px_hsl(0_85%_50%_/_0.6)]'}`} />
            ...
            <div className={`rounded-lg border border-primary/30 ${isLite ? 'bg-card p-6' : 'bg-card/50 md:backdrop-blur-sm p-6 shadow-sm transition-all hover:shadow-[0_0_20px_hsl(0_85%_50%_/_0.3)] hover:border-primary/60 hover:bg-card/70'}`}>
              <Shield className={`mb-4 h-10 w-10 text-primary ${isLite ? '' : 'md:drop-shadow-[0_0_8px_hsl(0_85%_50%_/_0.6)]'}`} />
            ...
            <div className={`rounded-lg border border-primary/30 ${isLite ? 'bg-card p-6' : 'bg-card/50 md:backdrop-blur-sm p-6 shadow-sm transition-all hover:shadow-[0_0_20px_hsl(0_85%_50%_/_0.3)] hover:border-primary/60 hover:bg-card/70'}`}>
              <Clock className={`mb-4 h-10 w-10 text-primary ${isLite ? '' : 'md:drop-shadow-[0_0_8px_hsl(0_85%_50%_/_0.6)]'}`} />
            ...
            <div className={`rounded-lg border border-primary/30 ${isLite ? 'bg-card p-6' : 'bg-card/50 md:backdrop-blur-sm p-6 shadow-sm transition-all hover:shadow-[0_0_20px_hsl(0_85%_50%_/_0.3)] hover:border-primary/60 hover:bg-card/70'}`}>
              <TrendingUp className={`mb-4 h-10 w-10 text-primary ${isLite ? '' : 'md:drop-shadow-[0_0_8px_hsl(0_85%_50%_/_0.6)]'}`} />
      ...
      <footer className={`border-t border-primary/20 ${isLite ? 'bg-card py-8' : 'bg-card/30 md:backdrop-blur-sm py-8'} relative z-10`}>
