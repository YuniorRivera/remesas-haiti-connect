...
export function TestimonialsCarousel() {
  ...
  return (
    <div className="relative w-full">
      <Card className={`${isLite ? 'border border-accent/30' : 'border-accent/30 bg-card/30 backdrop-blur-md shadow-2xl hover:shadow-[0_0_30px_hsl(0_85%_72%_/_0.4)]'} transition-all duration-300`}>
